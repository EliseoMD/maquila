...
public class FabricControllerTest {
    ...
    public void getAllTest() throws Exception {
        mvc.perform(get("/fabrics").accept(MediaType.APPLICATION_JSON)).andDo(print())
    ...
    public void getByIdTest() throws Exception {
        mvc.perform(get("/fabrics/2").accept(MediaType.APPLICATION_JSON)).andDo(print())
                .andExpect(status().isOk())
    ...
    public void getByIdNotFoundTest() throws Exception {
        mvc.perform(get("/fabrics/0").accept(MediaType.APPLICATION_JSON)).andDo(print())
